...
{   
    public class AutoTrooper : Enemy
    {
        ...
        public PaintColorHandler paintColorHandler;
        ...
        private void CheckForPaint()
        {
            ...
            else if (channel == team.teamChannel)
            {
            ...
            if (channel != -1 && paintColorHandler.environmentChannel != channel) 
            {
                paintColorHandler.UpdateEnvironmentColor(channel);
            }
