...
namespace Gameplay
{
    ...
    public class PaintSwim : MonoBehaviour
    {
        ...
        {
            Physics.Raycast(_playerHead.position, -_camOffset.up, out _belowHit, 1f, _terrainMask);
        ...
        {
            if (Physics.Raycast(frontCheck.position, -frontCheck.up, out RaycastHit frontHit, 1f, _terrainMask))
            {
